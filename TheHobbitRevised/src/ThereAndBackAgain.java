...
public class ThereAndBackAgain 
{
	...
	{
		String distanceofEntirePartyAsAString = "";
		for(Traveler name: party) {
			distanceofEntirePartyAsAString += name.getName() + " has traveled " + name.getDistanceTraveled() + "miles \n";
		}
		
		//for(int i=0; i<party.size();i++) {
		//	distanceofEntirePartyAsAString += party.get(i).getName() + " has traveled " + party.get(i).getDistanceTraveled() + " miles \n";
		//}
		
		
		return distanceofEntirePartyAsAString;
	}
